...
df_ecsv = pd.read_csv('finance/_data/earnings_source/earnings_latest.csv', sep=',', parse_dates=['date'])
...
liquid_stocks = pd.read_parquet('finance/_data/state/liquid_stocks.parquet')['symbol'].tolist()

out_dir = 'finance/_data/research/swing/earnings'
