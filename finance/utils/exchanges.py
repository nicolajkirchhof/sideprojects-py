...
US_EXCHANGE = {'TZ':pytz.timezone('America/Chicago'), 'Open': timedelta(hours=8, minutes=30), 'Close': timedelta(hours=16, minutes=30), 'PostClose': timedelta(hours=17), 'PreOpen': timedelta(hours=4, minutes=30)}
