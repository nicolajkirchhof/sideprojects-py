...
def analyze_indicator_influence_ml(df_eval, name):
  ...
  print(f"\nTop 3 Influence Factors for {name}:")
  print(importance_df.tail(3).index.tolist()[::-1])

#%% Execute ML Analysis
analyze_indicator_influence_ml(df_eval_c, "C Strategy")
analyze_indicator_influence_ml(df_eval_np, "NP Strategy")
analyze_indicator_influence_ml(df_eval_nc, "NC Strategy")
analyze_indicator_influence_ml(df_eval_p, "P Strategy")
