...
from finance.swing_pm.atrp_x_data_processing import df_ticker
...
#%%
def fn_flt(df):
  return df['std_mv'] > 1.5

utils.momentum.evaluate_liquid_symbols(name, fn_flt, spy_data, liquid_symbols,  start_at_name='QDEL') #, stop_at_name='QDEL')
