"""
finance.apps.momentum_dashboard._dashboard
=============================================
DashboardQt — the main QMainWindow subclass for the momentum/earnings dashboard.
"""
...
class DashboardQt(QtWidgets.QMainWindow):
  ...
  def _load_data_from_ui(self) -> None:
    from finance.apps.momentum_dashboard import _GLOBAL_LOADED_DF
    import finance.apps.momentum_dashboard as _mod
    ...
    if df_new is None or df_new.empty:
      ...
      _mod._GLOBAL_LOADED_DF = self.df
      self._show_empty_state()
      self._update_data_status()
