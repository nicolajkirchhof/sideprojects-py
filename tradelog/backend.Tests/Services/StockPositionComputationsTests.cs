...
public class StockPositionComputationsTests
{
    [Fact]
    public void SingleBuy_ReturnsCorrectRunningFields()
    {
        var trades = new List<StockPosition>
        {
            new() { Id = 1, Symbol = "AAPL", Date = new(2025, 1, 1), PosChange = 100, Price = 150m, Multiplier = 1 }
        };

        var result = StockPositionComputations.ComputeRunningFields(trades);
    ...
    {
        var result = StockPositionComputations.ComputeRunningFields(new List<StockPosition>());
