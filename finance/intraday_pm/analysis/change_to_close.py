...
results_df.to_parquet(f'{directory}/{symbol}_change_to_close_results.parquet')
#%%
results_df = pd.read_parquet(f'{directory}/{symbol}_change_to_close_results.parquet')
