...
base_path = f'finance/_data/research/swing/{output_name}'
data_path = f'{base_path}/data'
os.makedirs(data_path, exist_ok=True)

# Load Core Data
print("Loading core data...")
liquid_symbols = utils.underlyings.get_liquid_underlyings()
...
if all_data:
    ...
    df_all.to_parquet(f'finance/_data/research/swing/all_{output_name}.parquet', index=False)
    print(f"Complete. Saved to finance/_data/research/swing/all_{output_name}.parquet")
